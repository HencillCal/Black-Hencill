 ...
 * send the resulting Gifted~ session to the newly linked number's own DM.
 * The bot's primary socket is never replaced or logged out.
 */
async function startGiftedPairing(numberInput) {
...
module.exports = { startGiftedPairing, normalizePairNumber };
